    ...
    <div className='py-10'>
      <div className='container'>
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
          {/* image section  */}
          <div>
            <img data-aos="zoom-in" src={assets.library} alt="" className='max-w-[400px] block mx-auto h-[350px] w-full drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover'/>
          </div>
        {/* text content scetion */}
        <div data-aos="slide-up" className='flex flex-col justify-center gap-6 sm:pt-0'>
          ...
          <p className='text-sm text-gray-500 tracking-wide leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed error nisi tempore, iste harum dignissimos totam assumenda modi. Veniam, autem blanditiis</p>
